          ...
          <div class="card-body buttons-demo">
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <sweet-modal ref="error_modal" icon="error" title="Oh noes…">
                  This is an error…
                  <button
                    slot="button"
                    type="button"
            ...
            <div class="row mt-5">
              <div class="col-sm-6">
                ...
                <p>
                  It also supports a dark theme for modal and the modal overlay
                </p>
                <button
                  type="button"
                  class="btn btn-primary"
              ...
              <div class="col-sm-6">
                ...
                <p>
                  You can add custom HTML as content for modal including Videos
                  & tables (iframe)
                </p>
                <button
                  type="button"
                ...
                <sweet-modal
                  ...
                  overlay-theme="dark"
                >
                  This is <b>HTML</b>-<i>Content</i>. <br /><br />
                  <iframe
                    width="560"
                    height="315"
            ...
            <div class="row mt-5">
              ...
              <div class="col-sm-6">
                ...
                <p>
                  Set a custom width to your modal based on your requirements
                </p>
                <button
                  type="button"
                  class="btn btn-primary"
                ...
                <sweet-modal ref="wide_modal" title="Ultra Wide" width="90%">
            ...
            <div class="row mt-5">
              <div class="col-sm-6">
                ...
                <p>
                  You can also have a nested modal which gets triggered by the
                  parent modal thus allowing a possibility to have multiple
                  modals to be open at a time
                </p>
                <button
                  type="button"
                  class="btn btn-primary"
              ...
              <div class="col-sm-6">
                ...
                <p>
                  You can add as much content as you wish! It'll automatically
                  scroll
                </p>
                <button
                  type="button"
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <sweet-modal ref="tabbed_modal">
                  ...
                  <sweet-modal-tab id="tab3" title="Tab 3" disabled>
                    Tab 3 is disabled
                  </sweet-modal-tab>
                </sweet-modal>
              </div>
              <div class="col-sm-6">
                ...
                <p>
                  Use custom icons to represent the tabs instead of just a
                  boring title
                </p>
                <button
                  type="button"
                ...
                <sweet-modal ref="tabbed_modal_icon">
                  <sweet-modal-tab id="tab1" :icon="icons_anchor" title="Tab 1">
                    Contents of Tab 1
                  </sweet-modal-tab>
                  <sweet-modal-tab id="tab2" :icon="icons_sun" title="Tab 2">
                    Contents of Tab 2
                  </sweet-modal-tab>
                  <sweet-modal-tab
                    id="tab3"

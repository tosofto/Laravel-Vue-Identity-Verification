      ...
      <div class="card-body">
        <div class="row">
          <div class="col-sm-6">
            ...
            <button v-tooltip.top-center="tooltipText" class="btn btn-primary">
              Hover me
            </button>
          </div>
        ...
        <div class="row mt-5">
          ...
          <div class="col-sm-6">
            ...
            <div class="form-group">
              <button v-close-popover.all class="btn btn-warning">
                Close All
              </button>
            </div>
            ...
            <div class="row align-items-start">
              ...
              >
                ...
                <template slot="popover">
                  ...
                  <button v-close-popover class="btn btn-theme btn-sm">
                    Close
                  </button>
                </template>
                <!-- ... -->
